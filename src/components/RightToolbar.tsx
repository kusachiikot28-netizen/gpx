  ...
  return (
    <div className="absolute right-4 top-4 z-[1000] flex flex-col gap-4">
      <div className="flex flex-col bg-[#1a1a1a] text-white rounded-lg shadow-2xl p-1 gap-1 border border-white/10">
        <button onClick={onZoomIn} className="p-2 hover:bg-white/10 rounded transition-colors"><Plus size={20} /></button>
        <button onClick={onZoomOut} className="p-2 hover:bg-white/10 rounded transition-colors"><Minus size={20} /></button>
